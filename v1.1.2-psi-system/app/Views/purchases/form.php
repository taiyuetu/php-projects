    ...
    <form method="post" action="<?= Router::url('/purchases') ?>" id="purchase-form">
        ...
        <div class="form-row">
            <div class="form-group" style="flex:1;">
                <label>备注信息</label>
                <textarea name="notes" rows="3" placeholder="输入备注或说明..."></textarea>
            </div>
        </div>
        ...
        <div class="add-item-area">
            <div class="add-item-row">
                ...
                <div class="form-group">
                    <input type="number" id="add-cost" min="0" step="0.01" value="0" placeholder="单位成本" style="width:110px;">
                </div>
        ...
        <table class="line-items" id="items-table">
            <thead>
                <tr><th style="width:40%;">商品</th><th>数量</th><th>单位成本</th><th>小计</th><th></th></tr>
            </thead>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">保存采购</button>
            <a href="<?= Router::url('/purchases') ?>" class="btn btn-secondary">取消</a>
        </div>
    </form>
</div>
