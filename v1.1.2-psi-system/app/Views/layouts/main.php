...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="<?= Router::url('/changelogs') ?>" class="<?= $isActive('/changelogs') ?>">📋 Change Logs</a>
            <?php if (($user['role'] ?? '') === 'admin'): ?>
                <a href="<?= Router::url('/admin/changelogs') ?>" class="<?= $isActive('/admin/changelogs') ?>">⚙️ Log Management</a>
            <?php endif; ?>
        </nav>
    </aside>
