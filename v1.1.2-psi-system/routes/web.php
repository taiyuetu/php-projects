...
Router::get('/suppliers/export', 'SupplierController@exportCsv');
Router::get('/suppliers/import', 'SupplierController@importForm');
Router::post('/suppliers/import', 'SupplierController@importCsv');
...
Router::get('/customers/export', 'CustomerController@exportCsv');
Router::get('/customers/import', 'CustomerController@importForm');
Router::post('/customers/import', 'CustomerController@importCsv');
...
Router::get('/products/export', 'ProductController@exportCsv');
Router::get('/products/import', 'ProductController@importForm');
Router::post('/products/import', 'ProductController@importCsv');
