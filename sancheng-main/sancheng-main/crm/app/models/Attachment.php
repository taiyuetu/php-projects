...
class Attachment extends Model
{
    ...
    {
        // UPLOAD_PATH so the backup tests (and odd hosting layouts) can point the
        // attachment folder elsewhere; the web URL stays /uploads/attachments.
        $dir = defined('UPLOAD_PATH') ? UPLOAD_PATH : BASE_PATH . '/public/uploads/attachments';
        if (!is_dir($dir)) {
            mkdir($dir, 0755, true);
        }
        return $dir;
